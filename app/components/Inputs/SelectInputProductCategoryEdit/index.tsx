...
const SelectInputProductCategoryEdit = ({ setValue, items, itemsIcons, setSelectCategory, errors, register, selectCategory }: Props) => {
    ...
    return (
        <div className='w-full flex flex-col gap-1'>
            ...
            {selectCategory ?
                <Select.Root onValueChange={(value) => changeSelect(value)} value={selectCategory}>
...
export default SelectInputProductCategoryEdit