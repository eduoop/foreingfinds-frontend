          ...
          <div className='rounded-full py-1 px-1 flex items-center border-neutralBlack border cursor-pointer group duration-200 hover:border-primaryOrange gap-2'>
            {user.avatar ?
              <div className='flex gap-2 items-center group-hover:text-primaryOrange duration-200'>
                ...
                <h2 className='font-roboto max-w-[200px] overflow-hidden'>{FilterFistName(userSurname)}</h2>
              </div>
              :
              <div className='flex gap-2 items-center group-hover:text-primaryOrange duration-200'>
            ...
            <MdOutlineKeyboardArrowDown className="w-[25px] h-[25px] text-primaryGraffiti group-hover:text-primaryOrange duration-200"/>
          </div>
        }
      </div>
    </LoggedUserDropdown>
