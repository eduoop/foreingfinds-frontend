        ...
        <div className='w-full flex flex-col tablet:flex-row gap-3 h-full mt-2'>
          <div className='w-full tablet:w-[60%] h-full flex flex-col gap-4'>
            ...
            <div>
              ...
              <div className='flex gap-5 tablet:gap-10 mt-5 w-full'>
                <div className='flex flex-col'>
                  <small>Categoria</small>
                  <h2 className='text-primaryOrange'>{ad.productCategory.name}</h2>
                </div>
                <div className='flex flex-col'>
                  <small>Subcategoria</small>
                  <h2 className='text-primaryOrange'>{ad.subcategory.name}</h2>
                </div>
              </div>
            </div>
